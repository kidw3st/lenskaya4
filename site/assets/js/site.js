...
(function () {
  ...
  LK.PHOTO_SLOTS = {
    '404-01':1,'ABOUT-01':1,'ABOUT-02':1,'ABOUT-03':1,'ABOUT-05':1,
    'ANALOG-BLOCK':1,'ARCH-01':1,'ARCH-02':1,'ARCH-03':1,'ARCH-04':1,
    'ARCH-08':1,'ARCH-09':1,'ARCH-10':1,'CLUB-01':1,'CLUB-02':1,
    'CONCEPT-AXO-01':1,'CONCEPT-AXO-02':1,'CONCEPT-AXO-03':1,'CONCEPT-INSOL':1,'CONCEPT-MAP':1,
    'CONCEPT-REDLINE':1,'CONCEPT-TERRACE':1,'CONCEPT-UTILS':1,'CONCEPT-ZONING':1,'CTA-BG-01':1,
    'GREEN-CORRIDOR':1,'HERO-01F':1,'INFRA-01':1,'INTRO-01':1,'INTRO-02':1,
    'INTRO-03':1,'LAND-PLOT-A':1,'LAND-PLOT-B':1,'LOCATION-01':1,'LOCATION-02':1,
    'LOCATION-03':1,'MANIFEST-01':1,'MAP-02':1,'MASTERPLAN-02':1,'OG-01':1,
    'OG-LAND-01':1,'QUARTER-01':1,'QUARTER-02':1,'QUARTER-03':1,'SITE-PANO':1,
    'SITE-PHOTO-01':1,'SITE-PHOTO-02':1,'VIEW-RIVER':1,'YARD-01':1,'YARD-03':1,
    'YARD-05':1,
  };
  ...
  /* ====================================================================
     ...
     выдумывать. Если появятся точные координаты — впишите их
     в data-map-ll у нужного блока.
     ==================================================================== */

  const MAP_QUERY = {
    location: 'Пермь, улица Ленская, 42Д',
    office: 'Пермь, улица Ленская, 42Д',
  };
